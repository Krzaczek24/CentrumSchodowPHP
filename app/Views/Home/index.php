...
<html>
    <head>
        ...
        <?php
            include_once(__DIR__ . "/../../ViewHelpers/Divider.php");
            include_once(__DIR__ . "/../../ViewHelpers/TileWithMultiText.php");
    ...
    <body>
        ...
        <div class="full-screen-container">
            <?php
                ...
                renderAutoGallery(getAutoGalleryElements());
            ?>
        </div>
        ...
        <div class="full-width">
            <?php
                renderTileWithMultiText(getTileElement());
            ?>
        </div>
        ...
        <div class="full-width">
            <?php
                ...
                renderSideBySideGallery(getSideBySideGalleryElements());
            ?>
        </div>
        ...
        <div class="full-width">
            <?php
                ...
                renderTableGallery(getTileGalleryElements());
            ?>
        </div>
...
function getAutoGalleryElements()
{
    return [
...
function getTileElement()
{
    ...
    $subTiles = [
        new SubTileModel("/public/extras/images/icons/ico1.png", "Kreatywność", "Nieustannie powiększamy swój asortyment."),
        new SubTileModel("/public/extras/images/icons/ico2.png", "Gotowi na wyzwania", "Na bieżąco śledzimy nowe trendy w architekturze schodów."),
        new SubTileModel("/public/extras/images/icons/ico3.png", "Unikalne projekty", "Sprawimy, że Twój projekt będzie jedyny w swoim rodzaju."),
        new SubTileModel("/public/extras/images/icons/ico4.png", "Doświadczenie fachowcy", "Znamy się na schodach jak mało kto.")
    ];

    return new TileModel("/public/extras/images/gallery/tile.jpg", $mainTitle, $subTiles);
}

function getSideBySideGalleryElements()
{
    return [
...
function getTileGalleryElements()
{
    return [
        new GalleryElementModel('/public/extras/images/gallery/photo1.jpg', null, null),
        new GalleryElementModel('/public/extras/images/gallery/photo2.jpg', null, null),
